...
const ImageSection: React.FC = () => {
  return (
    <div className="w-full min-h-screen bg-white p-4 sm:p-6 lg:p-8">
      <div className="relative w-full h-full min-h-screen bg-white overflow-hidden rounded-2xl sm:rounded-3xl lg:rounded-3xl">
        {/* Background Image */}
              ...
              <div className="text-white space-y-6 lg:space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg sm:text-xl lg:text-2xl text-gray-200 max-w-lg">
                    Join India&apos;s first structured, skill-based sports
                    trading course from industry level experts and start earning
                    now!
                  </p>
                </div>
              </div>
